...
namespace BlueSapphire.Views
{
    public sealed partial class MediaManagerPage : Page, IMediaViewInteraction
    {
        ...
        {
            ViewModel.Operations.DeleteSelectedCommand.Execute(ImageGrid.SelectedItems);
        }
        ...
        {
            ViewModel.Operations.OpenSelectedLocationCommand.Execute(SingleSelectionFromMenu(sender));
        }

        private void ContextEditTags_Click(object sender, RoutedEventArgs e)
        {
            ViewModel.Operations.EditSelectedMediaTagsCommand.Execute(SingleSelectionFromMenu(sender));
        }

        private void ContextEnhance_Click(object sender, RoutedEventArgs e)
        {
            ViewModel.Operations.OpenEnhanceDialogCommand.Execute(SingleSelectionFromMenu(sender));
        }

        private void ContextDelete_Click(object sender, RoutedEventArgs e)
        {
            ViewModel.Operations.DeleteSelectedCommand.Execute(SingleSelectionFromMenu(sender));
        }
